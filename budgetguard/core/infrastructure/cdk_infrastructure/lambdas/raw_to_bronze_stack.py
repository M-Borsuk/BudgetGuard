...
class RawToBronzeLambdaStack(Stack):
    ...
    def get_lambda_image(self, image_name: str):
        ...
        ecr_image = _lambda.DockerImageCode.from_ecr(
            ...
            tag="0.20.0",
            cmd=["budgetguard.core.lambda_functions.raw_to_bronze.lambda_handler"],  # noqa
    ...
    def build_lambda_func(self, lambda_image: _lambda.Code):
        ...
        bucket = _s3.Bucket.from_bucket_name(self, id="budget-guard-ingest", bucket_name="budget-guard-ingest")
